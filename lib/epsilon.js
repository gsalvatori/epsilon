		...
		DLevenshtein: function(source,target){
			...
			if (sourceLength === 0 || targetLength === 0){
				...
				&& source[sourceLength-2] == target[targetLength-1]) {
					...
					DLevenshtein(H1,target)+1,
					DLevenshtein(source,H2)+1,
					DLevenshtein(H1,H2)+cost,
					DLevenshtein(source.substring(0,sourceLength-2),target.substring(0,targetLength-2)+1)
