		...
		*/
		...
		DLevenshtein: function(source,target){
			...
			if (sourceLength === 0 || targetLength === 0){
				return max(sourceLength,targetLength);
			}else{
				...
				&& source[sourceLength-2] == target[targetLength-1]) {
					...
					damerauLevenshteinDistance(H1,target)+1,
					damerauLevenshteinDistance(source,H2)+1,
					damerauLevenshteinDistance(H1,H2)+cost,
					damerauLevenshteinDistance(source.substring(0,sourceLength-2),target.substring(0,targetLength-2)+1)
